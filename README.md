...
- ✅ Visualização em tabela (`JTable`) com todos os dados:
  - Nome, CPF, Telefone, Data de Nascimento, Endereço, Saldo
- ✅ Busca rápida por CPF
- ✅ Interface moderna e responsiva com cores e ícones intuitivos
- ✅ Dados armazenados em memória (lista de objetos `Cliente`)
